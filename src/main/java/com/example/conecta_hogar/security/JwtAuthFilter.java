...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        // 1. Si no viene el token o no empieza por "Bearer ", dejamos pasar la petición inmediatamente
        if (authHeader == null || !authHeader.startsWith("Bearer ")) {
            System.out.println("⚠️ NO SE ENCONTRÓ HEADER 'Authorization' VÁLIDO (Debe empezar por 'Bearer ')");
        ...
        try {
            ...
            if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                System.out.println("🛡️ ROLES CARGADOS EN SECURITY: " + userDetails.getAuthorities());
            ...
            // Captura limpia del error de token inválido / simulado sin arrojar la excepción completa
            System.err.println("⚠️ TOKEN JWT INVÁLIDO O MALFORMADO: " + e.getMessage());
